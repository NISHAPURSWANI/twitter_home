  ...
  <div class="container">
    <div class="leftside_nav">
      <div class="leftside">
        ...
        <i
          class="fas fa-home"
          style="font-size:50px; padding-top:10px; padding-bottom:10px;"
        ></i>
        <i
        ...
        <i
          ...
          style="font-size:50px; padding-top:10px; padding-bottom:10px; margin-left:2px;"
        ></i>
        <i
            ...
            <div class="mycards">
              <div class="card1">
                ...
                <p class="cardtext">
                  ...
                  toll mounts to 37,758 with 278 deaths, reports PTI quoting
            ...
            <div class="mycards">
              <div class="card1">
                ...
                <p class="cardtext" style="margin-top:5px;">
                  adds 14,348 #Covid19 cases, taking state's tally to 14,30,861;
                  toll mounts to 37,758 with 278 deaths, reports PTI quoting
                  state health department. <br />8:26 PM · Oct 3, 2020·TweetDeck
                </p>
                <p class="iconsonfeed">
